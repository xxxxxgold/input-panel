...
mod tests {
    ...
    fn floating_orb_alpha_region_runs_cover_the_avatar_shape() {
        assert_eq!(FLOATING_ORB_ALPHA_REGION_RUNS.len(), 56);
        assert_eq!(FLOATING_ORB_ALPHA_REGION_RUNS[0], (2, 23, 37));
        assert_eq!(FLOATING_ORB_ALPHA_REGION_RUNS[1], (3, 20, 40));
        assert_eq!(FLOATING_ORB_ALPHA_REGION_RUNS.last(), Some(&(57, 23, 37)));
        assert_eq!(
